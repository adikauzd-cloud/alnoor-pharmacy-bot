...
# ከዚህ በፊት BOT_TOKEN እና ADMIN_CHAT_ID በቀጥታ በኮድ ውስጥ (hardcoded) ተጽፈው ነበር።
# ይህ በጣም አደገኛ ነው - ኮዱን የሚያይ ማንኛውም ሰው ቦትዎን ሙሉ ይቆጣጠረዋል።
# አሁን Environment Variable ውስጥ ብቻ እንዲቀመጡ ተደርጓል (default የለም)።
# እባክዎ ቀድሞ የነበረውን ቶከን ከ @BotFather ጋር revoke/regenerate ያድርጉ!
